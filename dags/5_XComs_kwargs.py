...
# Method 2 of XComms ie manually pushing and pulling of XComms. Allows easier debugging and more control over the XComs being pushed and pulled. 
# This is more recommended appraoch when working with XComs in Airflow. 
