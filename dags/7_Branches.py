...
def branch_dag():
    ...
    def decider_task(**kwargs):
        ...
        if weekend_flag == "true":
            return 'no_load_task' # Note - The value returned by the decider task should be the task_id of the task to be executed next. In this case, if the weekend_flag is true, then the no_load_task will be executed next. If the weekend_flag is false, then the load_task will be executed next.
        else:
            return 'load_task'
